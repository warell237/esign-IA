  ...
  return (
    <main style={{ width: '100%', height: '100dvh', overflow: 'hidden', background: isDark ? '#000010' : '#f2f5ff', position: 'relative', fontFamily: 'Arial, sans-serif', transition: 'background 0.4s ease' }}>
      ...
      <div style={{ position: 'fixed', top: isMobile ? '12px' : '20px', right: isMobile ? '12px' : '20px', zIndex: 100 }}>
        <button onClick={toggleTheme} style={{ width: isMobile ? '38px' : '44px', height: isMobile ? '38px' : '44px', borderRadius: '10px', border: isDark ? '1px solid rgba(255,255,255,0.1)' : '1px solid rgba(0,0,0,0.1)', background: isDark ? 'rgba(255,255,255,0.05)' : 'rgba(0,0,0,0.05)', backdropFilter: 'blur(20px)', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', transition: 'all 0.3s ease' }}>
          {isDark ? (
      ...
      <div style={{ position: 'absolute', top: isMobile ? '38%' : '42%', left: '50%', transform: 'translate(-50%, -50%)', zIndex: 10, textAlign: 'center', pointerEvents: 'none', width: '90%', maxWidth: '500px' }}>
        ...
        <p style={{ color: isDark ? 'rgba(200, 210, 255, 0.85)' : 'rgba(10, 16, 53, 0.7)', fontSize: subtitleSize, letterSpacing: subtitleSpacing ? '4px' : '8px', margin: `0 0 ${isMobile ? '18px' : '25px'} 0`, fontWeight: '300' }}>ASSISTANT INTELLIGENT</p>
      ...
      <div style={{ position: 'absolute', bottom: isMobile ? '6px' : '10px', left: '50%', transform: 'translateX(-50%)', zIndex: 10, textAlign: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 6 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <Link href="/about" style={{ color: isDark ? 'rgba(255,255,255,0.3)' : 'rgba(0,0,0,0.3)', fontSize: isMobile ? '8px' : '10px', textDecoration: 'none', padding: '2px 8px', borderRadius: 6, border: isDark ? '1px solid rgba(255,255,255,0.08)' : '1px solid rgba(0,0,0,0.06)', transition: 'all 0.2s' }}>A propos</Link>
        </div>
