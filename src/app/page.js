...
// src/app/page.js — Bannière PWA iOS + Android
// ============================================
    ...
    <main style={{
      ...
      {showInstallBanner && !isInstalled && (
        <div style={{
          ...
          zIndex: 200, width: '90%', maxWidth: 440,
          padding: isMobile ? '16px 18px' : '20px 24px', borderRadius: 16,
          background: isDark ? 'rgba(10,15,50,0.98)' : 'rgba(255,255,255,0.98)',
          border: `1px solid ${isDark ? 'rgba(255,255,255,0.1)' : 'rgba(0,0,0,0.08)'}`,
          backdropFilter: 'blur(20px)',
          boxShadow: '0 10px 40px rgba(0,0,0,0.3)',
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: isIOS ? 12 : 8 }}>
            ...
            <span style={{ color: isDark ? 'white' : '#0a1035', fontWeight: 700, fontSize: 15 }}>
              Installer ESIGN AI
            </span>
          </div>
              ...
              {[
                ...
                <div key={i} style={{ display: 'flex', gap: 10, alignItems: 'flex-start', marginBottom: 8 }}>
                  <span style={{
                    ...
                    background: '#4488ff', color: 'white', fontSize: 12, fontWeight: 700,
                    display: 'flex', alignItems: 'center', justifyContent: 'center',
                  }}>
                    {step.num}
                  </span>
                  <span style={{ color: isDark ? 'rgba(255,255,255,0.7)' : 'rgba(0,0,0,0.6)', fontSize: 13, lineHeight: 1.5 }}>
                    {step.text}
                  </span>
                </div>
              ))}
      ...
      <div style={{ position: 'absolute', bottom: bottomGap, left: '50%', transform: 'translateX(-50%)', zIndex: 10, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: isMobile ? '10px' : '14px', width: '90%', maxWidth: btnMaxWidth, pointerEvents: 'auto' }}>
        ...
        <p style={{ color: isDark ? 'rgba(255, 255, 255, 0.3)' : 'rgba(10, 16, 53, 0.4)', fontSize: isMobile ? '10px' : '12px', margin: `${isMobile ? '6px' : '10px'} 0 0 0`, textAlign: 'center' }}>
          {isMobile ? '50 questions/jour - Premium 1000 FCFA/mois' : '50 questions gratuites par jour - Premium des 1 000 FCFA/mois'}
        </p>
      </div>
